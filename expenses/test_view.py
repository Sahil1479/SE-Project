...
class TestExpense(TestCase):
    def setUp(self):
        ...
        # self.edit_expense_url = reverse('expense-edit')
        # self.delete_expense_url = reverse('expense-delete')
    ...
    #     self.client.login(username='sahil', password='password123')
    #     self.create_expense()
    #     created_expense = Userexpense.objects.filter(owner=self.user).order_by('-id')
